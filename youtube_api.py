...
class YouTubeAPI:
    ...
    def _get_api_key_from_config(self) -> Optional[str]:
        try:
            ...
            Logger.warning("config.json not found. Please create it with your YouTube API key.")
            return None
    ...
    def get_video_details(self, video_id: str) -> Optional[Dict]:
        ...
        try:
            ...
            if items:
                return self._parse_video_item(items[0], include_stats=True, include_details=True)
    ...
    def _parse_video_item(self, item: Dict, include_stats: bool = False, include_details: bool = False) -> Dict:
